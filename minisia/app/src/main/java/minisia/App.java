...
public class App {
    ...
    // public static List<String> listIndexNilai = Arrays.asList("A", "A-", "B+",
    // "B", "B-", "C+", "C", "D", "E");
    ...
    // boolean konfirm = konfirmasi("Konfirm tambah jurusan? " +
    // getLabelJurusan(jurusan));
    // if (konfirm) {
    ...
    // boolean konfirm = konfirmasi("Konfirm edit jurusan? " +
    // getLabelJurusan(tempJurusan));
    // if (konfirm) {
    ...
    // }
    // Jurusan jurusan = listJurusan.get(index);
    // boolean konfirm = konfirmasi("Konfirm hapus jurusan? kode: " + kode + ",
    // nama: " + jurusan.nama);
    // if (konfirm) {
    ...
    // public static int getIndexMataKuliahByKodeDanJurusan(String kode, Jurusan
    // jurusan) {
    ...
    // return "kode: " + mataKuliah.kode + ", nama: " + mataKuliah.nama + ", sks: "
    // + mataKuliah.sks;
    // }
    ...
    // boolean konfirm = konfirmasi("Konfirm tambah mata kuliah? " +
    // getLabelMataKuliah(mataKuliah));
    // if (konfirm) {
    ...
    // int indexMataKuliah = getIndexMataKuliahByKodeDanJurusan(kodeMataKuliah,
    // jurusan);
    ...
    // boolean konfirm = konfirmasi("Konfirm edit mata kuliah? " +
    // getLabelMataKuliah(tempMataKuliah));
    // if (konfirm) {
    ...
    // }
    // MataKuliah mataKuliah = jurusan.listMataKuliah.get(indexMataKuliah);
    // boolean konfirm = konfirmasi("Konfirm hapus mata kuliah? " +
    // getLabelMataKuliah(mataKuliah));
    // if (konfirm) {
    ...
    // return "nim: " + mahasiswa.nim + ", nama: " + mahasiswa.nama + ", jurusan: "
    ...
    // boolean konfirm = konfirmasi("Konfirm tambah mahasiswa? " +
    // getLabelMahasiswa(mahasiswa));
    // if (konfirm) {
    ...
    // boolean konfirm = konfirmasi("Konfirm edit mahasiswa? " +
    // getLabelMahasiswa(tempMahasiswa));
    // if (konfirm) {
    ...
    // }
    // Mahasiswa mahasiswa = listMahasiswa.get(indexMahasiswa);
    // boolean konfirm = konfirmasi("Konfirm hapus mahasiswa? " +
    // getLabelMahasiswa(mahasiswa));
    // if (konfirm) {
    ...
    // mahasiswa.jurusan.listMataKuliah.get(indexMataKuliah);
